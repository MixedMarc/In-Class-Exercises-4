...
public class MileageCalculatorConversion extends Application {
    ...
    private String[] conversions = {"MPG", "L/100KM"};
    ...
    public void start(Stage primaryStage) {   	
        ...
        ObservableList<String> convers = FXCollections.observableArrayList(conversions);
        cbo.getItems().addAll(convers);
    ...
    private void changeLabels(int index) {
    	...
    	if (index == 1  && lblCapacity.getText().equals(defaultCapacity)) {
        	// update labels
